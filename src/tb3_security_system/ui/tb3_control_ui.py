...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btn_buzzer.setGeometry(QRect(110, 680, 61, 61))
        ...
        self.btn_qrscan.setGeometry(QRect(200, 680, 61, 61))
        self.btn_switch = QPushButton(Dialog)
        self.btn_switch.setObjectName(u"btn_switch")
        self.btn_switch.setGeometry(QRect(30, 680, 61, 61))
        ...
        self.label_cam1.setGeometry(QRect(36, 36, 651, 271))
        ...
        self.btn_return_switch = QPushButton(Dialog)
        self.btn_return_switch.setObjectName(u"btn_return_switch")
        self.btn_return_switch.setGeometry(QRect(280, 680, 61, 61))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_switch.setText(QCoreApplication.translate("Dialog", u"\uc804\ud658", None))
        ...
        self.btn_return_switch.setText(QCoreApplication.translate("Dialog", u"\uad50\ub300", None))
    # retranslateUi
